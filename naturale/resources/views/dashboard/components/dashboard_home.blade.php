<div style="background-color: var(--page);" class="shadow-sm sm:rounded-lg border" style="border-color: var(--border);">
    <div class="p-8">
        <h3 class="text-lg font-bold mb-6 tracking-wider" style="color: var(--text);">Welcome, {{ auth()->user()->name }}</h3>
        <div class="grid grid-cols-3 gap-4">
            <a href="/dashboard/orders">
                <div class="relative aspect-square shadow-sm sm:rounded-lg border transition ease-in-out duration-150"
                    style="background-color: var(--page); border-color: var(--border);"
                    onmouseover="this.style.backgroundColor='var(--border)'" 
                    onmouseout="this.style.backgroundColor='var(--page)'">
                    <div>
                        <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            ...
                            <style>
                                .sh1s0 { fill: var(--text) }
                                .sh1s1 { fill: none; stroke: var(--text); stroke-linejoin: round; stroke-width: 32 }
                            </style>
                            <path id="Shape 3" fill-rule="evenodd" class="sh1s0" d="m173 176h166c7.18 0 13 5.82 13 13v6c0 7.18-5.82 13-13 13h-166c-7.18 0-13-5.82-13-13v-6c0-7.18 5.82-13 13-13z" />
                            <path id="Shape 3 copy" fill-rule="evenodd" class="sh1s0" d="m173 272h166c7.18 0 13 5.82 13 13v6c0 7.18-5.82 13-13 13h-166c-7.18 0-13-5.82-13-13v-6c0-7.18 5.82-13 13-13z" />
                            <path id="Shape 3 copy 2" fill-rule="evenodd" class="sh1s0" d="m173 368h166c7.18 0 13 5.82 13 13v6c0 7.18-5.82 13-13 13h-166c-7.18 0-13-5.82-13-13v-6c0-7.18 5.82-13 13-13z" />
                            <path id="Shape 1" fill-rule="evenodd" class="sh1s0" d="m208 32h95c8.84 0 16 7.16 16 16v64c0 8.84-7.16 16-16 16h-95c-8.84 0-16-7.16-16-16v-64c0-8.84 7.16-16 16-16z" />
                            <path id="Shape 2" fill-rule="evenodd" class="sh1s1" d="m416 80v384h-320v-384z" />
                        </svg>
                    </div>
                    <h2 class="text-lg font-bold ml-6 mt-4 mb-6 tracking-wider absolute bottom-0 left-0" style="color: var(--text);">
                        View Orders</h2>
                </div>
            </a>
                ...
                <div class="relative aspect-square shadow-sm sm:rounded-lg border transition ease-in-out duration-150"
                    ...
                    <div>
                        <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            style="width: 80%; height: auto; display: block; margin: auto; text-align:center;">
                            <style>
                                .sh3s0 { fill: none; stroke: var(--text); stroke-linejoin: round; stroke-width: 16 }
                            </style>
                            <path id="Shape 1" fill-rule="evenodd" class="sh3s0" d="m256 243c-47 0-85-38-85-85 0-47 37.99-85 85-85 47 0 85 37.99 85 85 0 47-38 85-85 85z" />
                            <path id="Shape 4" class="sh3s0" d="m146.86 438.86c-24.19 0-43.86-16.28-43.86-36.31v-54.46c0-70.18 68.23-105.12 153-105.12 84.77 0 154 34.94 154 105.12v54.46c0 20.03-19.67 36.31-43.86 36.31z" />
                        </svg>
                    </div>
                    <h2 class="text-lg font-bold ml-6 mt-4 mb-6 tracking-wider absolute bottom-0 left-0" style="color: var(--text);">
                        View Account</h2>
