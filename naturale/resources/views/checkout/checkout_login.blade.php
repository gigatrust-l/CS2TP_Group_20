<x-layouts.storefront title="{{-- Put title links here --}}">
    ...
    <div class="container py-5">
        <div class="max-w-5xl mx-auto px-4 py-12">
            ...
            <div class="grid grid-cols-12 gap-8 ">
                ...
                <div class="col-span-12 md:col-span-6 sect">
                    <div
                        class="dark:shadow-lg div-bg shadow-white shadow-sm sm:rounded-lg border p-8 h-full flex flex-col sect">
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('checkout.view') }}"
                                class="inline-flex items-center justify-center gap-2 w-full py-3 px-6 bg-green-600 text-white text-sm font-semibold rounded hover:bg-green-700 transition-colors duration-200">
                                Continue as Guest
                ...
                <div class="col-span-12 md:col-span-6 transition sect">
                    <div
                        class="dark:shadow-lg div-bg shadow-white shadow-sm sm:rounded-lg border p-8 h-full flex flex-col transition">
                        ...
                        <div x-data="{
                            openTab: {{ session('tab-page', 1) }},
                            activeClasses: 'border bg-gray-500 div-border rounded-top-3  text-white',
                            inactiveClasses: 'bg-green-600 border rounded-top-3 div-border hover:bg-green-700 text-white'
                        }" class="">
                            <ul class="flex div-bg rounded-3 mb-0">
                            ...
                            <div class="login border rounded-3 div-bg p-3 " x-show="openTab === 1">
                                <x-auth-session-status class="mb-4" :status="session('status')" />

                                <form method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <input type="hidden" name="tab_page" :value="openTab">

                                    <!-- Email Address -->
                                    <div>
                                        <label for="email"
                                            class="block font-medium text-sm">{{ __('Email') }}</label>
                                        <input id="email"
                                            class="block mt-1 w-full border text-bg rounded-md shadow-sm" type="email"
                                    ...
                                    <div class="mt-4">
                                        <label for="password"
                                            class="block font-medium text-sm">{{ __('Password') }}</label>

                                        <input id="password"
                                            class="block mt-1 w-full border text-bg rounded-md shadow-sm"
                                    ...
                                    <div class="relative block mt-4">
                                        ...
                                        @if (Route::has('password.request'))
                                            <a class="right-0 absolute underline text-sm forgot-password rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                            ...
                            <div class="register border rounded-3 div-bg p-3" x-show="openTab === 2">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div>
                                        <label for="name"
                                            class="block font-medium text-sm">{{ __('Name') }}</label>
                                        <input id="name"
                                            class="block mt-1 w-full border text-bg rounded-md shadow-sm"
                                    ...
                                    <div class="mt-4">
                                        <label for="password_confirmation"
                                            class="block font-medium text-sm">{{ __('Confirm Password') }}</label>
